...
if __name__=="__main__":
        ...
        def all_books_function1():

                path = "./les_categories_csv/" # -- Création d'un dossier pour toutes les catégories avec les données de leurs livres -- #
                if path==False:
                        os.mkdir(path)
                else:
                        pass
